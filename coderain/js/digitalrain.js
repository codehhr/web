...
(function () {
    ...
    if (!ok) {
      ...
      $panic(
        new $packages["runtime"].TypeAssertionError.ptr(
          "",
          value === $ifaceNil ? "" : value.constructor.string,
          type.string,
          missingMethod
        )
      );
          ...
          for (var i = 0; i < t.params.length; i++) {
            if (t.variadic && i === t.params.length - 1) {
              ...
              for (var j = 0; j < varargs.$length; j++) {
                args.push(
                  $externalize(varargs.$array[varargs.$offset + j], vt)
                );
              }
              break;
            }
  ...
  $packages["runtime"] = (function () {
    ...
    TypeAssertionError.ptr.prototype.Error = function () {
      ...
      if (e.concreteString === "") {
        return (
          "interface conversion: " + inter + " is nil, not " + e.assertedString
        );
      }
      if (e.missingMethod === "") {
        return (
  ...
  $packages["main"] = (function () {
    ...
    DigitalRain = $pkg.DigitalRain = $newType(
      0,
      $kindStruct,
      "main.DigitalRain",
      true,
    ...
    waterDrop = $pkg.waterDrop = $newType(
      0,
      $kindStruct,
      "main.waterDrop",
      true,
      "main",
      false,
      function (col_, row_, start_, speed_, glyphs_, spedup_, created_) {
        this.$val = this;
        if (arguments.length === 0) {
          this.col = 0;
          this.row = 0;
    ...
    GlyphCanvas = $pkg.GlyphCanvas = $newType(
      0,
      $kindStruct,
      "main.GlyphCanvas",
      true,
          ...
          s: while (true) {
            switch ($s) {
              case 0:
                rain1 = [rain1];
                rain2 = [rain2];
                lowGlyphCanvases = new sliceType([
                  NewGlyphCanvas("#6ba5b8"),
                  NewGlyphCanvas("#3b806d"),
                ]);
                highGlyphCanvases = new sliceType([
                  NewGlyphCanvas("#5b95a8"),
                  NewGlyphCanvas("#5b9b9b"),
                ]);
                backgrounds = new sliceType$1(["#dcedfe", "#000000"]);
                _tuple = NewDigitalRain(
              ...
              case 3:
                ...
                return;
              /* } */ case 2:
                cover = $global.document.createElement(
                  $externalize("div", $String)
                );
                cover.style.height = $externalize("100%", $String);
                cover.style.width = $externalize("100%", $String);
                cover.style[$externalize("background-image", $String)] =
                  $externalize(
                ...
                $global.addEventListener(
                  $externalize("resize", $String),
                  $externalize(
                    (function (rain1, rain2) {
                      return function () {
                        rain1[0].layout();
                      };
                    })(rain1, rain2),
              ...
              /* } */ case 5:
                ...
                rain2[0].Clicked = (function (rain1, rain2) {
                  return function () {
                    ...
                    return;
                    index = (index + 1) >> 0;
                    rain1[0].lowGlyphCanvas =
                      ((x =
                        ((_r$2 = index % 2),
                        _r$2 === _r$2
                          ? _r$2
                          : $throwRuntimeError("integer divide by zero"))),
                      x < 0 || x >= lowGlyphCanvases.$length
                        ? ($throwRuntimeError("index out of range"), undefined)
                        : lowGlyphCanvases.$array[
                            lowGlyphCanvases.$offset + x
                          ]);
                    rain1[0].highGlyphCanvas =
                      ((x$1 =
                        ((_r$3 = index % 2),
                        _r$3 === _r$3
                          ? _r$3
                          : $throwRuntimeError("integer divide by zero"))),
                      x$1 < 0 || x$1 >= highGlyphCanvases.$length
                        ? ($throwRuntimeError("index out of range"), undefined)
                        : highGlyphCanvases.$array[
                            highGlyphCanvases.$offset + x$1
                          ]);
                    rain2[0].lowGlyphCanvas =
                      ((x$2 =
                        ((_r$4 = index % 2),
                        _r$4 === _r$4
                          ? _r$4
                          : $throwRuntimeError("integer divide by zero"))),
                      x$2 < 0 || x$2 >= lowGlyphCanvases.$length
                        ? ($throwRuntimeError("index out of range"), undefined)
                        : lowGlyphCanvases.$array[
                            lowGlyphCanvases.$offset + x$2
                          ]);
                    rain2[0].highGlyphCanvas =
                      ((x$3 =
                        ((_r$5 = index % 2),
                        _r$5 === _r$5
                          ? _r$5
                          : $throwRuntimeError("integer divide by zero"))),
                      x$3 < 0 || x$3 >= highGlyphCanvases.$length
                        ? ($throwRuntimeError("index out of range"), undefined)
                        : highGlyphCanvases.$array[
                            highGlyphCanvases.$offset + x$3
                          ]);
                    $global.document.body.style.background = $externalize(
                      ((x$4 =
                        ((_r$6 = index % 2),
                        _r$6 === _r$6
                          ? _r$6
                          : $throwRuntimeError("integer divide by zero"))),
                      x$4 < 0 || x$4 >= backgrounds.$length
                        ? ($throwRuntimeError("index out of range"), undefined)
                        : backgrounds.$array[backgrounds.$offset + x$4]),
                      $String
                    );
                  };
                })(rain1, rain2);
    ...
    randi = function () {
      return ($parseFloat($global.Math.random()) * 2.147483647e9) >> 0;
    };
    NewDigitalRain = function (
      parent,
      screenCols,
      minSpeed,
      maxSpeed,
    ...
    DigitalRain.ptr.prototype.layout = function () {
      ...
      r.canvas = $global.document.createElement(
        $externalize("canvas", $String)
      );
      r.ctx = r.canvas.getContext($externalize("2d", $String));
      r.canvas.width = r.width;
      r.canvas.height = r.height;
      r.canvas.style.width = $externalize(
        ftoa(r.width / r.ratio) + "px",
        $String
      );
      r.canvas.style.height = $externalize(
        ftoa(r.height / r.ratio) + "px",
        $String
      );
      ...
      if (r.highGlyphCanvas === ptrType.nil) {
        r.highGlyphCanvas =
          ...
          x < 0 || x >= highGlyphCanvases.$length
            ? ($throwRuntimeError("index out of range"), undefined)
            : highGlyphCanvases.$array[highGlyphCanvases.$offset + x]);
      }
        ...
        r.lowGlyphCanvas =
          ((x$1 =
            ...
            _r$1 === _r$1
              ? _r$1
              : $throwRuntimeError("integer divide by zero"))),
          x$1 < 0 || x$1 >= lowGlyphCanvases.$length
            ? ($throwRuntimeError("index out of range"), undefined)
            : lowGlyphCanvases.$array[lowGlyphCanvases.$offset + x$1]);
      }
      r.canvas.addEventListener(
        $externalize("click", $String),
        $externalize(function $b(ev) {
          var ev, $s, $r;
          /* */ $s = 0;
          var $f,
            $c = false;
          ...
          s: while (true) {
            switch ($s) {
              case 0:
                /* */ if (
                  r.overLink($parseInt(ev.x) >> 0, $parseInt(ev.y) >> 0)
                ) {
                  $s = 1;
                  continue;
                }
      ...
      r.canvas.addEventListener(
        $externalize("mousemove", $String),
        $externalize(function (ev) {
          var ev;
    ...
    DigitalRain.ptr.prototype.overLink = function (x, y) {
      ...
      r = this;
      return (
        x > (((r.width / r.ratio) >> 0) - 320) >> 0 &&
        y > (((r.height / r.ratio) >> 0) - 50) >> 0
      );
    };
    DigitalRain.prototype.overLink = function (x, y) {
      return this.$val.overLink(x, y);
    };
    DigitalRain.ptr.prototype.dropWaterAtCol = function (
      col,
      speed,
      length,
      start,
    ...
    DigitalRain.prototype.dropWaterAtCol = function (
      col,
      speed,
      length,
      start,
    ...
    DigitalRain.ptr.prototype.dropRandomWaterDrop = function (timestamp) {
      ...
      while (true) {
        ...
        if (
          drop.col === col &&
          ((drop.row >> 0) - drop.glyphs.$length) >> 0 < 0
        ) {
          colcnt = (colcnt + 1) >> 0;
          if (colcnt > overlap) {
            return;
      ...
      speed =
        (((_r$1 = randi() % ((r.maxSpeed - r.minSpeed) >> 0)),
    ...
    DigitalRain.ptr.prototype.drawGlyphAt = function (
      nidx,
      col,
      row,
      brightness,
    ...
    DigitalRain.prototype.drawGlyphAt = function (
      nidx,
      col,
      row,
      brightness,
    ...
    DigitalRain.ptr.prototype.drawGlyphElAt = function (
      glyphCanvas,
      nidx,
      col,
      row,
    ...
    DigitalRain.prototype.drawGlyphElAt = function (
      glyphCanvas,
      nidx,
      col,
      row,
    ...
    shortLink = function (link) {
      ...
      while (true) {
        ...
        if (
          link.charCodeAt(i) === 58 &&
          (i + 2) >> 0 < link.length &&
          link.charCodeAt((i + 1) >> 0) === 47 &&
          link.charCodeAt((i + 2) >> 0) === 47
        ) {
    ...
    DigitalRain.ptr.prototype.drawTitle = function (text, color, fontSize, y) {
      ...
      y = r.height - pad - y;
      r.ctx.save();
      r.ctx.font = $externalize(
        itoa(fontSize >> 0) +
          "px Menlo, Consolas, Monospace, Helvetica, Arial, Sans-Serif",
        $String
      );
    ...
    NewGlyphCanvas = function (color) {
      var _1,
        ...
        i$1,
        row;
      glyphCanvas = new GlyphCanvas.ptr(
        $global.document.createElement($externalize("canvas", $String)),
        false
      );
      ...
      row = 1;
      _ref =
        "02345789ABCEGIJMNPRVXYZ:>+*~-\xE3\x85\xA3\xC5\x81";
      _i = 0;
      while (true) {
        if (!(_i < _ref.length)) {
          break;
        ...
        ctx.font = $externalize(
          itoa(fontSize >> 0) + "px Monaco, Helvetica, Arial, Sans-Serif",
          $String
        );
        ...
        if (_1 === 50 || _1 === 52 || _1 === 57) {
          ...
          ctx.translate(
            ...
            cellSize * row + (fontSize - cellSize)
          );
        } else {
          ctx.translate(
            cellSize * col + cellSize / 2,
    ...
    GlyphCanvas.ptr.prototype.Glyph = function (gx, gy) {
      ...
      mx =
        ((_entry = gc.glyphs[$Int.keyFor(gx)]),
        _entry !== undefined ? _entry.v : false);
      if (mx === false) {
        mx = {};
        _key = gx;
        (gc.glyphs || $throwRuntimeError("assignment to entry in nil map"))[
          $Int.keyFor(_key)
        ] = { k: _key, v: mx };
      }
      my =
        ((_entry$1 = mx[$Int.keyFor(gy)]),
        _entry$1 !== undefined ? _entry$1.v : null);
      if (my === null) {
        ...
        _key$1 = gy;
        (mx || $throwRuntimeError("assignment to entry in nil map"))[
          $Int.keyFor(_key$1)
        ] = { k: _key$1, v: my };
      }
      return my;
      ...
      s: while (true) {
        switch ($s) {
          ...
          case 1:
            ...
            githubLink = "http://github.com/codehhr/";
            level1Cols = 40;
            level2Cols = 60;
            index = 1;
            if ($pkg === $mainPkg) {
