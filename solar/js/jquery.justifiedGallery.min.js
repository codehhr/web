...
!(function (a) {
  ...
  (b.prototype.getSuffix = function (a, b) {
    ...
    (b.prototype.extractImgSrcFromImage = function (a) {
      var b =
        "undefined" != typeof a.data("safe-src")
          ? a.data("safe-src")
          : a.attr("src");
    ...
    (b.prototype.imgFromEntry = function (a) {
      var b = a.find("> img");
      return (
        0 === b.length && (b = a.find("> a > img")), 0 === b.length ? null : b
      );
    }),
    ...
    (b.prototype.displayEntryCaption = function (b) {
      ...
      if (null !== c && this.settings.captions) {
        ...
        null !== d &&
          (this.settings.cssAnimation ||
            d.stop().fadeTo(0, this.settings.captionSettings.nonVisibleOpacity),
    ...
    (b.prototype.prepareBuildingRow = function (a) {
      ...
      for (
        ...
        (c = this.buildingRow.entriesBuff[b]),
          ...
          g
            ? ((e = b === this.buildingRow.entriesBuff.length - 1 ? i : j * d),
              (f = j))
            : ((e = this.settings.rowHeight * d),
    ...
    (b.prototype.flushRow = function (a) {
      var b,
        ...
        f = this.border;
      if (
        ((c = this.prepareBuildingRow(a)),
        a && "hide" === e.lastRow && -1 === this.buildingRow.height)
      )
        return void this.clearBuildingRow();
      if (
        (this.maxRowHeight.isPercentage
          ? this.maxRowHeight.value * e.rowHeight < this.buildingRow.height &&
            (this.buildingRow.height = this.maxRowHeight.value * e.rowHeight)
          : this.maxRowHeight.value > 0 &&
        ...
        var g =
          this.galleryWidth -
          2 * this.border -
          (this.buildingRow.entriesBuff.length - 1) * e.margins;
      ...
      this.$gallery.height(
        this.offY +
          this.buildingRow.height +
          this.border +
          (this.isSpinnerActive() ? this.getSpinnerHeight() : 0)
      ),
      ...
      return (
        ...
        0 === this.entries.length
          ...
          : (this.settings.filter
              ? this.modifyEntries(this.filterArray, b)
              : this.modifyEntries(this.resetFilters, b),
            a.isFunction(this.settings.sort)
              ? this.modifyEntries(this.sortArray, b)
              : this.settings.randomize &&
                this.modifyEntries(this.shuffleArray, b),
            !0)
      );
    }),
    ...
    (b.prototype.modifyEntries = function (a, b) {
      var c = b
        ? this.entries.splice(
            this.lastAnalyzedIndex + 1,
            this.entries.length - this.lastAnalyzedIndex - 1
          )
        : this.entries;
    ...
    (b.prototype.checkOrConvertNumber = function (b, c) {
      if (
        ("string" === a.type(b[c]) && (b[c] = parseFloat(b[c])),
        "number" !== a.type(b[c]))
      )
      ...
      for (var d = { 0: "" }, e = 0; e < b.length; e++)
        if ("string" === a.type(b[e]))
          try {
            ...
            throw (
              "sizeRangeSuffixes keys must contains correct numbers (" + g + ")"
            );
          }
    ...
    (b.prototype.retrieveMaxRowHeight = function () {
      ...
      if ("string" === a.type(this.settings.maxRowHeight))
        this.settings.maxRowHeight.match(/^[0-9]+%$/)
          ? ((b.value =
              ...
              100),
            (b.isPercentage = !1))
          : ((b.value = parseFloat(this.settings.maxRowHeight)),
            (b.isPercentage = !0));
      else {
      ...
      return (
        b.isPercentage
          ? b.value < 100 && (b.value = 100)
          : b.value > 0 &&
            b.value < this.settings.rowHeight &&
            (b.value = this.settings.rowHeight),
        b
      );
    }),
    (b.prototype.checkSettings = function () {
      if (
        ...
        "justify" !== this.settings.lastRow &&
          "nojustify" !== this.settings.lastRow &&
          "left" !== this.settings.lastRow &&
          "center" !== this.settings.lastRow &&
          "right" !== this.settings.lastRow &&
          "hide" !== this.settings.lastRow)
      )
    ...
    (b.prototype.retrieveSuffixRanges = function () {
      var a = [];
      for (var b in this.settings.sizeRangeSuffixes)
        this.settings.sizeRangeSuffixes.hasOwnProperty(b) &&
